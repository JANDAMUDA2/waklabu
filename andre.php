...
include ("curl.php");
echo "\n";
echo "\e[94m            NOT SAFE FOR WORK IF2 silahkan coba            \n";
echo "\e[91m FORMAT NOMOR HP : INDONESIA '62***' , US='1***'\n";
echo "\e[93m SCRIPT GOJEK BUATAN ANDRE AUTO REGISTER + AUTO CLAIM VOUCHER\n";
echo "\n";
    ...
    if ($verif == false)
        ...
        if ($claim == false)
            ...
            if ($claim == false) {
                ...
                sleep(3);
                echo "\e[93m[!] Trying to redeem Voucher : GOFOOD22620A !\n";
                sleep(3);
                goto next1;
            }
            else{
                echo "\e[92m[+] ".$claim."\n";
                sleep(3);
                echo "\e[93m[!] Trying to redeem Voucher : GOFOOD226OA !\n";
                sleep(3);
                goto ride;
            }
            next1:
            ...
            if ($claim == false ) {
                echo "\033VOUCHER INVALID/GAGAL GARA GARA bang mamek gak ngerokok\n";
            }
            else{
                echo "\e[92m[+] ".$claim."\n";
